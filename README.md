...
Input: N = 17 Output: 1,2,Fizz,4,Buzz,Fizz,7,8,Fizz,Buzz,11,Fizz,13,14,FizzBuzz,16,17
...
Input: [1, 2, 3, 5, 8, 4, 7, 9, 1, 4, 12, 5, 6, 5, 2, 1, 0, 8, 1] Output: 1 - 4 2 - 2 5 - 3 8 - 2 4 - 2
...
Input: {"Rick": 85, "Amit": 42, "George": 53, "Tanya": 60, "Linda": 35} Output: 275
...
Assumptions/Tips:
    ...
    Bowler can bowl any number of overs
    Assume Batsman 1 is on strike for the first ball.

Below is an example:

Input : [1,2,0,0,4,1,6,2,1,3];

Output: Total Score: 20 Batsman 1 Score : 4 (1 + 3) Batsman 2 Score : 16 (2 + 4 + 1 + 6 + 2 + 1)
